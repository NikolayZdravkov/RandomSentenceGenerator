string[] names = { "Steven", "Peter", "Jane", "Viktor" };
...
Console.WriteLine("Hi, this is your first random-generated sentence:");
...
while (true)
{
    ...
    Console.WriteLine("Click [Enter] to generate a new one or [q] to quit.");
